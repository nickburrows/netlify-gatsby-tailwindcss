    ...
    >
      ...
      <g clipPath="url(#a)">
        <g fill={isDark ? "#fff" : "#000"}>
          ...
          />
          <path d="M79.7 14.4c-.7-.6-1.3-.7-1.6-.7-.7 0-1.1.3-1.1.8 0 .3.1.6.9.9l.7.2c.126.047.262.095.404.144.757.263 1.675.582 2.096 1.256.3.4.5 1 .5 1.7 0 .9-.3 1.8-1.1 2.5s-1.8 1.1-3 1.1c-2.1 0-3.2-1-3.9-1.7l1.5-1.7c.6.6 1.4 1.2 2.2 1.2s1.4-.4 1.4-1.1c0-.6-.5-.9-.9-1l-.6-.2-.209-.089c-.646-.273-1.35-.57-1.89-1.111-.5-.5-.8-1.1-.8-1.9 0-1 .5-1.8 1-2.3.8-.6 1.8-.7 2.6-.7.7 0 1.9.1 3.2 1.1zm18.8 6.1L93.7 12H97l3.1 5.7 2.8-5.7h3.2l-8 15.3h-3.2zM47 13.7h7c0 .063.01.127.02.193a.978.978 0 01-.02.507c0 4.5-3.4 8.1-8 8.1s-8-3.6-8-8.1 3.6-8.1 8-8.1c2.6 0 5 1.2 6.5 3.3l-2.3 1.5C49.2 9.8 47.6 9 46 9c-2.9 0-4.9 2.5-4.9 5.4s2.1 5.3 5 5.3c2.6 0 4-1.3 4.6-3.2H47z" />
        </g>
        <path
